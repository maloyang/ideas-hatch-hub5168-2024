...
AmebaServo myservo_left;
AmebaServo myservo_right;

void forward()
{
    myservo_left.write(180);     //0=順時針, 180=逆時針
...
void backward()
{
    myservo_left.write(0);   //0=順時針, 180=逆時針
...
void turnLeft()
{
    ...
    myservo_right.write(0);  //0=順時針, 180=逆時針
...
void setup() {
    ...
    myservo_right.attach(PA25);
    myservo_left.attach(PA26);
}
